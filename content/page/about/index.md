...
고등학교 재학 중 Flutter + Firebase로 학교 앱을 1인 개발했습니다. Java로 프로토타입을 만들다 Flutter로 넘어왔고, 급식·시간표·게시판·채팅·성적 관리까지 하나의 앱에 담아 혼자 출시했습니다. 코딩은 독학으로 익혔고, 기숙사 자습 시간과 주말을 활용해 만들었습니다.

이 블로그는 앱을 만들면서 겪은 것들을 기록하는 공간입니다. 기술을 고른 이유, 삽질한 과정, 구조를 바꾼 배경 같은 것들을 담습니다. 튜토리얼이라기보다는 개발 일지에 가깝습니다.
